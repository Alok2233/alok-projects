...
const ClientsTab = () => {
  ...
  const createMutation = useMutation({
    mutationFn: async (data) => {
      return await clientsApi.create(data, imageFile);
    },
    onSuccess: () => {
    ...
    onError: (error) => toast.error(error.message || "Failed to create client"),
  });

  const updateMutation = useMutation({
    mutationFn: async ({ id, data }) => {
      return await clientsApi.update(id, data, imageFile);
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["clients"] });
    ...
    onError: (error) => toast.error(error.message || "Failed to update client"),
  });
          ...
          <DialogContent>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                />
                {editingClient?.image_url && !imageFile && (

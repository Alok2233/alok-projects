            ...
            : displayProjects.map((project, index) => (
                ...
                >
                  <div className="relative overflow-hidden rounded-lg mb-4 shadow-card hover:shadow-elevated transition-shadow duration-300">
                    <img
                      src={getImageUrl(project.image_url) || "https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=400&q=80"}
                      alt={project.name}
                      className="w-full h-48 object-cover transition-transform duration-500 group-hover:scale-110"
                    />
                    <div className="absolute inset-0 bg-primary/0 group-hover:bg-primary/10 transition-colors duration-300" />
                  </div>
                  <h3 className="font-semibold text-accent mb-1 group-hover:text-primary transition-colors duration-300">
                    {project.name}
                  </h3>
                  ...
                  <Button
                    variant="default"
                    size="sm"
                    className="bg-accent hover:bg-accent/90 text-accent-foreground hover:scale-105 transition-transform duration-200"
                  >
                    Read More
                  </Button>
                </div>
